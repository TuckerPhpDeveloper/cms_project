                        ...
                        <div class="col-sm-12">
                            <table class="data-table table stripe hover nowrap">
                                ...
                                <tbody>
                                    <?php
                                        $sr = 1;
                                        $query = "SELECT * FROM fca_users where status=1 and `parent_idtag`='group' and `m_status`=0";
                                        ...
                                        if (mysqli_num_rows($result)>0)
                                        {
                                            while ($row = mysqli_fetch_array($result))
                                            {
                                                ...
                                                if($calculated_wallet!=$wallet_amount)
                                                {
                                                       ...
                                                       if($password=='*test' or $password=='*free')
                                                       {
                                                            $wallet_status="tally";
                                                       }
                                                }
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo " Rs. ".$wallet_amount; ?></td>
                                                    <!--<td><?php echo " Rs. ".$credit; ?></td>-->
                                                    <!--<td><?php echo " Rs. ".$debit; ?></td>-->
                                                    <!--<td><?php echo " Rs. ".$calculated_wallet; ?></td>-->
                                                    <td><?php echo $wallet_status.":".round($calculated_wallet-$wallet_amount,2);?></td>
                                                    ...
                                                    <a href="users_group_<?php echo $row['mobile']; ?>"><h5><i class="dw dw-eye"></i></h5> 
                                                    <a href="users_transaction_<?php echo $row['idtag']; ?>"><h5><i class="dw dw-login"></i></h5> 
                                                    </td>
                                                </tr>
                                                <?php
                                                $sr++;
