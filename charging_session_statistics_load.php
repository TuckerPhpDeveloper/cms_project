...
$query = mysqli_query($connect, "select charger_id from fca_connectors where 1");
$count = 0;
$con_id = "";
...
if (mysqli_num_rows($query1) > 0) {
    while ($row1 = mysqli_fetch_array($query1)) {
        ...
        $query4 = mysqli_query($connect, "select name from fca_users where idtag = '$idtag' || dc_idtag = '$idtag'");
    ...
    $result .= "
    <tr>
        <td colspan='11' style='text-align: center;'> There is no live charging </td>
    </tr>";
}
